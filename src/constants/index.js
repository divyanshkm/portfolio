  ...
  export const workExperiences = [
    {
      ...
      title: "Gained experience in new technologies such as ML, IoT, and SAP, while contributing to various practice projects for Edunet Foundation",
      icon: '/assets/experience/edunet.png',
      animation: 'victory',
    },
    {
      id: 2,
      ...
      title: "Completed various front-end tasks and presented on Software Development Life Cycle, gaining more experience in the field and improving my skills.",
      icon: '/assets/experience/HackvedaLogo1.png',
      animation: 'clapping',
    },
