...
export default function WebDevModel(props) {
  const { nodes, materials } = useGLTF("./models/web dev.glb");
  return (
    <Float>
      <group {...props} dispose={null}>
        <group rotation={[-Math.PI / 2, 0, 0]}>
          <group rotation={[Math.PI / 2, 0, 0]} scale={0.01}>
            <group>
              <group position={[376.682, -7.091, 50.928]} scale={100}>
                <mesh
                  castShadow
                  receiveShadow
              ...
              <group position={[-462.212, 33.56, -281.908]} scale={100}>
                <mesh
                  castShadow
                  receiveShadow
              ...
              <group position={[-355.475, -11.127, -14.417]} scale={100}>
                <mesh
                  castShadow
                  receiveShadow
              ...
              <group position={[-77.384, 336.624, -298.406]} scale={100}>
                <mesh
                  castShadow
                  receiveShadow
              ...
              <group position={[171.163, 322.3, -327.784]} scale={100}>
                <mesh
                  castShadow
                  receiveShadow
...
useGLTF.preload("./models/web dev.glb");
