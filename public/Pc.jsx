...
import CanvasLoader from "../src/components/CanvasLoader";
...
export default function Pc(props) {
  ...
  useEffect(() => {
    // Update the state after the component has finished rendering
    setLoading(false);
  });
          ...
          >
            <group name="RootNode">
              ...
              >
                ...
                >
                  <VideoMaterial src="./assets/video.mp4" />
                </mesh>
              </group>
              <group
                name="gigabyte-logo"
